...
var ytp = ytp || {},
  getYTPVideoID = function (a) {
    var b, c;
    return (
      a.indexOf("youtu.be") > 0 || a.indexOf("youtube.com/embed") > 0
...
!(function (jQuery, ytp) {
  (jQuery.mbYTPlayer = {
      ...
      if (
          ...
          .on("YTPData.YTPlayer", function () {
            if (a.hasData && a.isPlayer && !a.opt.autoPlay) {
              var b = a.opt.coverImage
                ? "url(" + a.opt.coverImage + ") center center"
                : a.orig_containment_background;
              console.debug("1", b),
        ...
        if (
          ...
          var b = a.opt.coverImage
            ...
            : a.orig_containment_background;
          b &&
            a.opt.containment.css({ background: b, backgroundSize: "cover" });
        }
        a.videoData = null;
      }
    ...
    applyFilter: function (a, b) {
      ...
      return d.isReady
        ? ((d.filters[a].value = b),
          void (d.filtersEnabled && c.YTPEnableFilters()))
        : this;
    },
...
var get_vimeo_videoID = function (a) {
  var b;
  return (b =
    a.indexOf("vimeo.com") > 0
      ? a.substr(a.lastIndexOf("/") + 1, a.length)
      : a.length > 15
      ? null
      : a);
};
!(function ($) {
  (jQuery.vimeo_player = {
      ...
      return (
        ...
        this.each(function () {
          ...
          (vimeo_player.loop = 0),
            ...
            (vimeo_player.state = {}),
            (vimeo_player.id =
              vimeo_player.id || "YTP_" + new Date().getTime()),
            $vimeo_player.addClass("vimeo_player");
          var property =
            $vimeo_player.data("property") &&
            "string" == typeof $vimeo_player.data("property")
              ? eval("(" + $vimeo_player.data("property") + ")")
              : $vimeo_player.data("property");
          if (
            (jQuery.extend(
              vimeo_player.opt,
              jQuery.vimeo_player.defaults,
              options,
              property
            ),
            (vimeo_player.opt.ratio =
              "auto" == vimeo_player.opt.ratio
                ? 16 / 9
                : vimeo_player.opt.ratio),
            eval(vimeo_player.opt.loop) && (vimeo_player.opt.loop = 9999),
            (vimeo_player.isRetina =
              window.retina || window.devicePixelRatio > 1),
            (vimeo_player.canGoFullScreen = !(
              jQuery.browser.msie ||
              jQuery.browser.opera ||
              isIframe()
            )),
            vimeo_player.canGoFullScreen ||
              (vimeo_player.opt.realfullscreen = !1),
            (vimeo_player.isAlone = !1),
            (vimeo_player.hasFocus = !0),
            (vimeo_player.videoID = this.opt.videoURL
              ? get_vimeo_videoID(this.opt.videoURL)
              : !!$vimeo_player.attr("href") &&
                get_vimeo_videoID($vimeo_player.attr("href"))),
            (vimeo_player.isSelf = "self" == vimeo_player.opt.containment),
            (vimeo_player.opt.containment =
              "self" == vimeo_player.opt.containment
                ? jQuery(this)
                : jQuery(vimeo_player.opt.containment)),
            (vimeo_player.opt.vol = vimeo_player.opt.vol / 10),
            (vimeo_player.isBackground =
              vimeo_player.opt.containment.is("body")),
            !vimeo_player.isBackground || !vimeo_player.backgroundIsInited)
          ) {
            (vimeo_player.playOnMobile =
              vimeo_player.opt.playOnMobile && jQuery.browser.mobile),
              vimeo_player.isSelf || $vimeo_player.hide();
            ...
            var playerID = "vimeo_player_" + vimeo_player.id,
              wrapper = jQuery("<div/>")
                ...
                .attr("id", "vimeo_player_wrapper_" + playerID);
            wrapper.css({
              position: "absolute",
              zIndex: 0,
              width: "100%",
              ...
              vimeo_player.isBackground
                ...
                : "static" == vimeo_player.opt.containment.css("position") &&
                  vimeo_player.opt.containment.css({ position: "relative" }),
              (vimeo_player.videoWrapper = wrapper),
              (vimeo_player.overlay = overlay),
              vimeo_player.isBackground ||
                overlay
                  .on("mouseenter", function () {
                    vimeo_player.controlBar &&
                      vimeo_player.controlBar.length &&
              ...
              jQuery(document).on("vimeo_api_loaded", function () {
                ...
                (vimeo_player.player = new Vimeo.Player(
                  vimeo_player.videoWrapper.get(0).id,
                  options
                )),
                  vimeo_player.player.ready().then(function () {
                    function start() {
                      (vimeo_player.isReady = !0),
                        vimeo_player.opt.mute &&
                          setTimeout(function () {
                            $vimeo_player.v_mute();
                          }, 1),
                        vimeo_player.opt.showControls &&
                          ...
                          ? vimeo_player.playOnMobile
                            ? setTimeout(function () {
                                (VEvent = jQuery.Event("VPStart")),
                                  ...
                                  vimeo_player.videoWrapper.fadeTo(
                                    vimeo_player.opt.fadeTime,
                                    vimeo_player.opt.opacity
                                  );
                              }, 1e3)
                            : setTimeout(function () {
                        ...
                        $vimeo_player.trigger(VEvent),
                        "function" == typeof vimeo_player.opt.onReady &&
                          vimeo_player.opt.onReady(vimeo_player),
                        $vimeo_player.v_optimize_display();
                    }
                    (vimeo_player.playerBox =
                      vimeo_player.videoWrapper.find("iframe")),
                      vimeo_player.playerBox.after(overlay);
                    var VEvent;
                    vimeo_player.opt.startAt
                      ? (vimeo_player.player.play().then(function () {
                          vimeo_player.player.pause();
                        }),
                        $vimeo_player.v_seekTo(
                          vimeo_player.opt.startAt,
                          function () {
                            start();
                          }
                      ...
                      : start(),
                      jQuery(window)
                        .off("resize.vimeo_player_" + vimeo_player.id)
                        .on(
                          "resize.vimeo_player_" + vimeo_player.id,
                          function () {
                      ...
                      vimeo_player.player.on("play", function (data) {
                        if (
                          ...
                          "undefined" != typeof _gaq &&
                            eval(vimeo_player.opt.gaTrack) &&
                            _gaq.push([
                              "_trackEvent",
                              "vimeo_player",
                              "Play",
                              vimeo_player.videoID,
                            ]),
                          "undefined" != typeof ga &&
                            eval(vimeo_player.opt.gaTrack) &&
                            ga(
                          ...
                          (VEvent.error = data),
                          $vimeo_player.trigger(VEvent),
                          vimeo_player.opt.addRaster)
                        ) {
                          var classN =
                            "dot" == vimeo_player.opt.addRaster
                              ? "raster-dot"
                              : "raster";
                          vimeo_player.overlay.addClass(
                            vimeo_player.isRetina ? classN + " retina" : classN
                          );
                        } else
                          vimeo_player.overlay.removeClass(function (a, b) {
                            var c = b.split(" "),
                              d = [];
                            return (
                              jQuery.each(c, function (a, b) {
                      ...
                      vimeo_player.player.on("timeupdate", function (a) {
                        if (
                          ((vimeo_player.duration = a.duration),
                          (vimeo_player.percent = a.percent),
                          (vimeo_player.seconds = a.seconds),
                          (vimeo_player.state = 1),
                          vimeo_player.player.getPaused().then(function (a) {
                            a && (vimeo_player.state = 2);
                          }),
                          vimeo_player.opt.stopMovieOnBlur &&
                            (document.hasFocus() ||
                              (1 == vimeo_player.state &&
                                ((vimeo_player.hasFocus = !1),
                                $vimeo_player.v_pause(),
                                (vimeo_player.document_focus = setInterval(
                                  function () {
                                    document.hasFocus() &&
                                      !vimeo_player.hasFocus &&
                                      ((vimeo_player.hasFocus = !0),
                                      $vimeo_player.v_play(),
                                      clearInterval(
                                        vimeo_player.document_focus
                                      ));
                                  },
                                  300
                                ))))),
                        ...
                        vimeo_player.opt.stopAt =
                          vimeo_player.opt.stopAt > a.duration
                            ? a.duration - 0.5
                            : vimeo_player.opt.stopAt;
                        var l = vimeo_player.opt.stopAt || a.duration - 0.5;
                        a.seconds >= l &&
                          ((vimeo_player.loop = vimeo_player.loop || 0),
                          vimeo_player.opt.loop &&
                          vimeo_player.loop < vimeo_player.opt.loop
                          ...
                          (VEvent.time = a.seconds),
                          $vimeo_player.trigger(VEvent);
                      });
                  }),
                  $vimeo_player.on("change_state", function () {
                    0 == vimeo_player.state &&
                      vimeo_player.videoWrapper.fadeOut(
                        vimeo_player.opt.fadeTime,
                        function () {
    ...
    togglePlay: function (a) {
      var b = this.get(0);
      return (
        1 == b.state ? this.v_pause() : this.v_play(),
        "function" == typeof a && a(b.state),
        this
      );
    },
    ...
    seekTo: function (a, b) {
      var c = this.get(0),
        d = c.opt.stopAt && a >= c.opt.stopAt ? c.opt.stopAt - 0.5 : a;
      return (
        c.player.setCurrentTime(d).then(function (a) {
    ...
    setVolume: function (a) {
      ...
      return (
        (b.isMute = !1),
        (b.opt.vol = a || b.opt.vol),
        b.player.setVolume(b.opt.vol),
        b.volumeBar &&
          b.volumeBar.length &&
          b.volumeBar.updateSliderVal(100 * a),
        this
      );
    },
    toggleVolume: function () {
      var a = this.get(0);
      if (a)
        return a.isMute ? (jQuery(a).v_unmute(), !0) : (jQuery(a).v_mute(), !1);
    },
    mute: function () {
      var a = this.get(0);
      if (a.isMute) return this;
      a.playOnMobile && a.player.toggleMute(),
        (a.isMute = !0),
        a.player.setVolume(0),
        a.volumeBar &&
          a.volumeBar.length &&
      ...
      return (
        c.html(jQuery.vimeo_player.controls.unmute),
        jQuery(a).addClass("isMuted"),
        a.volumeBar && a.volumeBar.length && a.volumeBar.addClass("muted"),
        this
      );
    ...
    unmute: function () {
      ...
      if (a.isMute) {
        (a.isMute = !1),
          a.playOnMobile && a.player.toggleMute(),
          jQuery(a).v_set_volume(a.opt.vol),
          a.volumeBar &&
            a.volumeBar.length &&
            a.volumeBar.updateSliderVal(a.opt.vol > 0.1 ? a.opt.vol : 0.1);
        var b = jQuery("#controlBar_" + a.id),
          c = b.find(".vimeo_player_muteUnmute");
        return (
          c.html(jQuery.vimeo_player.controls.mute),
          jQuery(a).removeClass("isMuted"),
          a.volumeBar && a.volumeBar.length && a.volumeBar.removeClass("muted"),
          this
        );
    ...
    changeMovie: function (a) {
      ...
      (c.opt.startAt = 0),
        ...
        c.player.loadVideo(a.videoURL).then(function (a) {
          b.v_optimize_display(),
            jQuery(c).v_play(),
            c.opt.startAt && b.v_seekTo(c.opt.startAt);
        });
    },
    buildControls: function (vimeo_player) {
      var data = vimeo_player.opt;
      if (!jQuery("#controlBar_" + vimeo_player.id).length) {
        vimeo_player.controlBar = jQuery("<span/>")
          .attr("id", "controlBar_" + vimeo_player.id)
        ...
        var buttonBar = jQuery("<div/>").addClass("buttonBar"),
          playpause = jQuery(
            "<span>" + jQuery.vimeo_player.controls.play + "</span>"
          )
          ...
          MuteUnmute = jQuery(
            "<span>" + jQuery.vimeo_player.controls.mute + "</span>"
          )
        ...
        var idx = jQuery("<span/>").addClass("vimeo_player_time"),
          ...
          progressBar = jQuery("<div/>")
            ...
            .click(function (a) {
              timeBar.css({ width: a.clientX - timeBar.offset().left }),
                (vimeo_player.timeW = a.clientX - timeBar.offset().left),
                vimeo_player.controlBar
                  .find(".vimeo_player_loaded")
                  .css({ width: 0 });
        ...
        progressBar.append(loadedBar).append(timeBar),
          buttonBar
            ...
            .append(volumeBar)
            .append(idx),
          data.show_vimeo_logo && buttonBar.append(movieUrl),
          (vimeo_player.isBackground ||
            (eval(vimeo_player.opt.realfullscreen) &&
              !vimeo_player.isBackground)) &&
            buttonBar.append(fullscreen),
          ...
          volumeBar.simpleSlider({
            ...
            callback: function (a) {
              0 == a.value
                ? jQuery(vimeo_player).v_mute()
                : jQuery(vimeo_player).v_unmute(),
                vimeo_player.player.setVolume(a.value / 100),
                vimeo_player.isMute || (vimeo_player.opt.vol = a.value);
            },
          });
      }
    },
    optimizeVimeoDisplay: function (align) {
      ...
      (vimeo_player.opt.align = align || vimeo_player.opt.align),
        (vimeo_player.opt.align =
          "undefined " != typeof vimeo_player.opt.align
            ? vimeo_player.opt.align
            : "center,center");
      ...
      if (vimeo_player.opt.optimizeDisplay) {
        var win = {},
          ...
          abundance = vimeo_player.isPlayer ? 0 : 0.15 * el.outerHeight();
    ...
    fullscreen: function (real) {
      function hideMouse() {
        vimeo_player.overlay.css({ cursor: "none" });
      }
      function RunPrefixMethod(a, b) {
        for (
          var c, d, e = ["webkit", "moz", "ms", "o", ""], f = 0;
      ...
      return (
        vimeo_player.isAlone
          ? (jQuery(document).off("mousemove.vimeo_player"),
            clearTimeout(vimeo_player.hideCursor),
            vimeo_player.overlay.css({ cursor: "auto" }),
            real
              ? cancelFullscreen()
              : videoWrapper
                  .fadeTo(vimeo_player.opt.fadeTime, vimeo_player.opt.opacity)
                  .css({ zIndex: 0 }),
            fullScreenBtn.html(jQuery.vimeo_player.controls.fullscreen),
            (vimeo_player.isAlone = !1))
          : (jQuery(document).on("mousemove.vimeo_player", function (a) {
              vimeo_player.overlay.css({ cursor: "auto" }),
                ...
                jQuery(a.target).parents().is(".vimeo_player_bar") ||
                  (vimeo_player.hideCursor = setTimeout(hideMouse, 3e3));
            }),
            hideMouse(),
            real
              ? (videoWrapper.css({ opacity: 0 }),
  ...
  $.fn.extend({
    mouseParallax: function (options) {
      var defaults = {
        moveFactor: 5,
        zIndexValue: "-1",
        targetContainer: ".construction-wrap, .working-process-style-1",
      };
